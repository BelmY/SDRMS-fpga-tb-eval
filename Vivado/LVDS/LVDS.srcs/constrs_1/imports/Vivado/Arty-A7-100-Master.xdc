...
create_clock -period 62.500 -name VIRTUAL_clk_out1_lvds_clk_wiz_0 -waveform {0.000 31.250}
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_lvds_clk_wiz_0] -min -add_delay 30.000 [get_ports LVDS_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_lvds_clk_wiz_0] -max -add_delay 32.500 [get_ports LVDS_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_lvds_clk_wiz_0] -min -add_delay 30.000 [get_ports LVDS_p]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_lvds_clk_wiz_0] -max -add_delay 32.500 [get_ports LVDS_p]
